...
| D-04 | pre-auth source, session, room, global packet·byte·fan-out budget과 rate-limit 기본값 | Go 보안 책임자(남용 모델), 제품 책임자(정상 부하), 운영 책임자(host 한계) | **후보 미승인; Phase 3 구현 전 owner 승인 필수** |
